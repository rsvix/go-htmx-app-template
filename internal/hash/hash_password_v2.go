...
// Check https://github.com/alexedwards/argon2id
...
func HashPasswordV2(password string) (hash string, err error) {
...
func CheckPasswordHashV2(password string, hash string) (match bool) {
	match, _, _ = CheckHash(password, hash)
	return match
}
