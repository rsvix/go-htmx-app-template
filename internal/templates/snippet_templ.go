...
func SnippetModal(c echo.Context, snippetName string, snippetLang string, snippetContent string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</h2><pre class=\"w-full text-sm font-normal leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white text-center my-4\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
